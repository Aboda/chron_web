let content = {
    "en":{
        ...
        "intro":`Thanks for using Synchronicity. These Terms of Use ('Terms' or 'Agreement') are a legal agreement between you and Synchronicity Cloud LLC ('Synchronicity,' 'we,' 'our,' or 'us') and govern your use of all the text, data, information, software, graphics, photographs and more that we and our affiliates may make available to you (all of which we refer to as 'Documentation'), including our websites and any services, plug-ins, software or other Downloadable Tools (as defined below) that we may provide through any of our websites (the 'Platform' or 'Website' and together with the Materials, these 'Service(s)'). Synchronicity 'Users' are the people who have created used the Synchronicity application (also referred to as 'Customer(s)')
